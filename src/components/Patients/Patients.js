    ...
    return (
      <section className='patient-care-section'>
        ...
        <ExpansionPanel className='card' >
          ...
          <br/>
          <p>
            <h4 className='sub-header'>Control Your Pain: </h4>
        ...
        <ExpansionPanel className='card' >
          ...
          <br/>
          <p>
            <h4 className='sub-header'>1. Punch Technique: </h4>
          ...
          <br/>
          <p>
            <h4 className='sub-header'>2. Open Technique: </h4>
            (You have stitches). 
          </p>
          <br/>
          <p>
            <h4 className='sub-header'>Post-Anesthesia: </h4>
        ...
        <ExpansionPanel className='card' >
          ...
          <br/>
          <p>
            <h4 className='sub-header'>Medication: </h4>
        ...
        <ExpansionPanel className='card' >
          ...
          <br/>
          <p>
            <h4 className='sub-header'>Clean Your Mouth: </h4>
